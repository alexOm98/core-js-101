 ...
 *
 */
const getPowerFunction = (exponent) => (a) => a ** exponent;
...
function memoize(func) {
  const cache = new Map();
  return (a) => (cache.has(a) ? cache : cache.set(a, func(a))).get(a);
}
...
function retry(func, attempts) {
  let attemClone = attempts;
  return function fn() {
    try { return func(); } catch (e) { fn(attemClone -= 1); return func(); }
  };
}
